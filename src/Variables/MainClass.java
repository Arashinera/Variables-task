...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nOrder №1.\nClient : " + name + ".\nProduct : " + product + ", price EUR " + SMARTPHONE_PRICE + ".\nAddress : " + street + ", " + house + ".\n");

        //Очищуємо наш сканер аби після int не було перешкод.
        input.nextLine();

        //Створюємо друге замовлення використовуючи ті ж самі змінні аби не збільшувати напругу для швидкодії програми.
        ...
        //Виводимо інформацію о замовленнях :

        System.out.println("\nOrder №2.\nClient : " + name + ".\nProduct : " + product + ", price EUR " + LAPTOP_PRICE + ".\nAddress : " + street + ", " + house + ".");
